...
python -O main.py --method walker_1 --dimension_dataset 2  --weight_soft_cost 0     --train False
python -O main.py --method walker_2 --dimension_dataset 2  --weight_soft_cost 0     --train False
...
python -O main.py --method walker_1 --dimension_dataset 3  --weight_soft_cost 0     --train False
python -O main.py --method walker_2 --dimension_dataset 3  --weight_soft_cost 0     --train False
